...
################################################################################
## Form generated from reading UI file 'mainttulnI.ui'
##
...
"")
        ...
        self.extraTopMenu_2.setGeometry(QRect(0, 0, 222, 405))
        ...
        self.btn_basic_2 = QPushButton(self.extraTopMenu_2)
        self.btn_basic_2.setObjectName(u"btn_basic_2")
        sizePolicy.setHeightForWidth(self.btn_basic_2.sizePolicy().hasHeightForWidth())
        self.btn_basic_2.setSizePolicy(sizePolicy)
        self.btn_basic_2.setMinimumSize(QSize(0, 45))
        palette = QPalette()
...
#endif
        self.btn_basic_2.setPalette(palette)
        self.btn_basic_2.setFont(font)
        self.btn_basic_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_basic_2.setLayoutDirection(Qt.LeftToRight)
        self.btn_basic_2.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-plus.png);")

        self.verticalLayout_16.addWidget(self.btn_basic_2)

        self.btn_agreement_2 = QPushButton(self.extraTopMenu_2)
        self.btn_agreement_2.setObjectName(u"btn_agreement_2")
        sizePolicy.setHeightForWidth(self.btn_agreement_2.sizePolicy().hasHeightForWidth())
        self.btn_agreement_2.setSizePolicy(sizePolicy)
        self.btn_agreement_2.setMinimumSize(QSize(0, 45))
        self.btn_agreement_2.setFont(font)
        self.btn_agreement_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_agreement_2.setMouseTracking(True)
        self.btn_agreement_2.setLayoutDirection(Qt.LeftToRight)
        self.btn_agreement_2.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-equalizer.png);")

        self.verticalLayout_16.addWidget(self.btn_agreement_2)

        self.btn_demand_2 = QPushButton(self.extraTopMenu_2)
        self.btn_demand_2.setObjectName(u"btn_demand_2")
        sizePolicy.setHeightForWidth(self.btn_demand_2.sizePolicy().hasHeightForWidth())
        self.btn_demand_2.setSizePolicy(sizePolicy)
        self.btn_demand_2.setMinimumSize(QSize(0, 45))
        self.btn_demand_2.setFont(font)
        self.btn_demand_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_demand_2.setLayoutDirection(Qt.LeftToRight)
        self.btn_demand_2.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-zoom-in.png);")

        self.verticalLayout_16.addWidget(self.btn_demand_2)

        self.btn_file_2 = QPushButton(self.extraTopMenu_2)
        ...
        self.btn_file_2.setMinimumSize(QSize(0, 45))

        self.verticalLayout_16.addWidget(self.btn_file_2)

        self.btn_buyNotice_2 = QPushButton(self.extraTopMenu_2)
        self.btn_buyNotice_2.setObjectName(u"btn_buyNotice_2")
        sizePolicy.setHeightForWidth(self.btn_buyNotice_2.sizePolicy().hasHeightForWidth())
        self.btn_buyNotice_2.setSizePolicy(sizePolicy)
        self.btn_buyNotice_2.setMinimumSize(QSize(0, 45))
        self.btn_buyNotice_2.setBaseSize(QSize(0, 45))

        self.verticalLayout_16.addWidget(self.btn_buyNotice_2)

        self.btn_enroll_2 = QPushButton(self.extraTopMenu_2)
        self.btn_enroll_2.setObjectName(u"btn_enroll_2")
        sizePolicy.setHeightForWidth(self.btn_enroll_2.sizePolicy().hasHeightForWidth())
        self.btn_enroll_2.setSizePolicy(sizePolicy)
        self.btn_enroll_2.setMinimumSize(QSize(0, 45))

        self.verticalLayout_16.addWidget(self.btn_enroll_2)
        ...
        self.extraTopMenu_3.setGeometry(QRect(0, 0, 222, 405))
        ...
        self.btn_basic_5 = QPushButton(self.extraTopMenu_3)
        self.btn_basic_5.setObjectName(u"btn_basic_5")
        sizePolicy.setHeightForWidth(self.btn_basic_5.sizePolicy().hasHeightForWidth())
        self.btn_basic_5.setSizePolicy(sizePolicy)
        self.btn_basic_5.setMinimumSize(QSize(0, 45))
        self.btn_basic_5.setFont(font)
        self.btn_basic_5.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_basic_5.setLayoutDirection(Qt.LeftToRight)
        self.btn_basic_5.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-plus.png);")

        self.verticalLayout_22.addWidget(self.btn_basic_5)

        self.btn_agreement_5 = QPushButton(self.extraTopMenu_3)
        self.btn_agreement_5.setObjectName(u"btn_agreement_5")
        sizePolicy.setHeightForWidth(self.btn_agreement_5.sizePolicy().hasHeightForWidth())
        self.btn_agreement_5.setSizePolicy(sizePolicy)
        self.btn_agreement_5.setMinimumSize(QSize(0, 45))
        self.btn_agreement_5.setFont(font)
        self.btn_agreement_5.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_agreement_5.setLayoutDirection(Qt.LeftToRight)
        self.btn_agreement_5.setStyleSheet(u"background-image: url(:/icons/images/icons/cil-equalizer.png);")

        self.verticalLayout_22.addWidget(self.btn_agreement_5)
...
"background-repeat: no-repeat;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_basic_2.setText(QCoreApplication.translate("MainWindow", u"\u57fa\u672c\u4fe1\u606f", None))
        self.btn_agreement_2.setText(QCoreApplication.translate("MainWindow", u"\u5f00\u6807\u73b0\u573a", None))
        self.btn_demand_2.setText(QCoreApplication.translate("MainWindow", u"\u8d44\u683c\u5ba1\u67e5", None))
        self.btn_file_2.setText(QCoreApplication.translate("MainWindow", u"\u7b26\u5408\u6027\u5ba1\u67e5", None))
        self.btn_buyNotice_2.setText(QCoreApplication.translate("MainWindow", u"\u8bc4\u5206", None))
        self.btn_enroll_2.setText(QCoreApplication.translate("MainWindow", u"\u7ed3\u679c", None))
        self.btn_basic_5.setText(QCoreApplication.translate("MainWindow", u"\u57fa\u672c\u4fe1\u606f", None))
        self.btn_agreement_5.setText(QCoreApplication.translate("MainWindow", u"\u79fb\u4ea4\u60c5\u51b5", None))
